    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidUpdate(prevProps, prevState) {
            if (prevState.options.length !== this.state.options.length) {
                ...
                localStorage.setItem('options', json); //Store on localStorage. During the pageLoad.
            }
        }
    }, {
        ...
        value: function render() {
            //Nesting components in Parent Container Indecision App.
...
var Options = function Options(props) {
    return React.createElement(
        ...
        props.options.map(function (option) {
            ...
            }); // Reuse the Option component. Need to set key for in map.Unique Identifier
        })
    );
};
...
var AddOption = function (_React$Component2) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOption(e) {
            ...
            //Short hand syntax. If variable and property same name can write in this manner.
            if (!error) {
